                ...
                <div class="flex items-center justify-between">
                    @if($blog->politician)
                        <div class="flex items-center">
                            <svg aria-label="{{$blog->politician->fullName()}}" class="pzggbiyp" data-visualcompletion="ignore-dynamic" role="img" style="height: 168px; width: 168px;">
                                <mask id="jsc_c_2">
                    ...
                    <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold">
                        @if($blog->id > $first)
                            <span class="text-sm text-gray-400">Predchádzajúca reakcia</span>
                            <a href="{{ route('oneBlogHelper', ['blog' => $blog, 'plus' => '0']) }}" class="btn btn-primary"><i
                                    class="fa fa-arrow-left"></i></a>
                        @endif
                        @if($blog->id < $last)
                            <a href="{{ route('oneBlogHelper', ['blog' => $blog, 'plus' => '1']) }}" class="btn btn-primary"><i
                                    class="fa fa-arrow-right"></i></a>
                            <span class="text-sm text-gray-400">Ďalšia reakcia</span>
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gray-200 bg-opacity-25">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-gray-600 leading-7 font-semibold"> {!! $blog->title !!} </div>
                    </div>
